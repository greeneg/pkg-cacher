...
<tr bgcolor=\"#cccccc\"><td>For more information on pkg-cacher visit <a href=\"http://sourceforge.net/projects/pkg-cacher\">http://sourceforge.net/projects/pkg-cacher</a>.
</td></tr>
</table>";
